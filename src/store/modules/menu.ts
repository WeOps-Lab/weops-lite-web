                            ...
                            auth: [
                                {
                                    ...
                                    label: '查看',
                                    type: 'check',
                                    apiKey: ['classification_search', 'model_list', 'model_attr_list', 'instance_list', 'group_list', 'instance_detail', 'instance_association_instance_list', 'model_association_type', 'topo_search']
                                },
                                {
